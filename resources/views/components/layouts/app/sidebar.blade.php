...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group>
                <flux:navlist.item icon="cube" href="#" wire:navigate>{{ __('Pedidos') }}</flux:navlist.item>
            </flux:navlist.group>

            <flux:navlist.group>
                <flux:navlist.item icon="credit-card" href="#" wire:navigate>{{ __('Pagos') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>

        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Métricas')" class="grid">
               <flux:navlist.item icon="presentation-chart-line" href="#" wire:navigate>{{ __('Ventas') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
